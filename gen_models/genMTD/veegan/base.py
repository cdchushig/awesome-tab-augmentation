...
from veegan.errors import UnsupportedDataset

LOGGER = logging.getLogger(__name__)


class Baseline(abc.ABC):
    """Base class for all the ``SDGym`` gen_models."""
...
class LegacySingleTableBaseline(SingleTableBaseline, abc.ABC):
    ...
    This class exists here to support the legacy gen_models which do not operate
